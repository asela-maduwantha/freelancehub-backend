...
export class FreelancerController {
  ...
  @Post('profile/create')
  @ApiOperation({
    summary: 'Create complete freelancer profile for onboarding',
  })
  @ApiResponse({
    status: HttpStatus.CREATED,
  ...
  async createCompleteProfile(
    ...
    return this.freelancerService.createCompleteFreelancerProfile(
      req.user.id,
      profileDto,
    );
  }
  ...
  async updateProfessionalProfile(
    ...
    return this.freelancerService.updateProfessionalProfile(
      req.user.id,
      professionalDto,
    );
  }
  ...
  async updateLanguagesProfile(
    ...
    return this.freelancerService.updateLanguagesProfile(
      req.user.id,
      languagesDto,
    );
  }
  ...
  async updateVisibilitySettings(
    ...
    return this.freelancerService.updateVisibilitySettings(
      req.user.id,
      visibilityDto,
    );
  }
  ...
  async addCertification(
    ...
    return this.freelancerService.addCertification(
      req.user.id,
      certificationDto,
    );
  }
  ...
  async addPortfolioItemToProfile(
    ...
    return this.freelancerService.addPortfolioItemToProfile(
      req.user.id,
      portfolioDto,
    );
  }
