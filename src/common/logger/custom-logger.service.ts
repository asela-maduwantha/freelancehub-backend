...
export class CustomLogger extends ConsoleLogger implements LoggerService {
  ...
  log(message: any, context?: string) {
    ...
    if (typeof message === 'object') {
      ...
      console.log(
        `\x1b[32m[${timestamp}] [${logLevel}] ${contextStr}${message}\x1b[0m`,
      );
    }
  }
  ...
  error(message: any, trace?: string, context?: string) {
    ...
    if (typeof message === 'object') {
      console.error(
        `\x1b[31m[${timestamp}] [${logLevel}] ${contextStr}\x1b[0m`,
      );
      console.error(JSON.stringify(message, null, 2));
    } else {
      console.error(
        `\x1b[31m[${timestamp}] [${logLevel}] ${contextStr}${message}\x1b[0m`,
      );
    }
  ...
  warn(message: any, context?: string) {
    ...
    if (typeof message === 'object') {
      ...
      console.warn(
        `\x1b[33m[${timestamp}] [${logLevel}] ${contextStr}${message}\x1b[0m`,
      );
    }
  }
  ...
  debug(message: any, context?: string) {
    ...
    if (typeof message === 'object') {
      console.debug(
        `\x1b[36m[${timestamp}] [${logLevel}] ${contextStr}\x1b[0m`,
      );
      console.debug(JSON.stringify(message, null, 2));
    } else {
      console.debug(
        `\x1b[36m[${timestamp}] [${logLevel}] ${contextStr}${message}\x1b[0m`,
      );
    }
  }
  ...
  verbose(message: any, context?: string) {
    ...
    if (typeof message === 'object') {
      ...
      console.log(
        `\x1b[35m[${timestamp}] [${logLevel}] ${contextStr}${message}\x1b[0m`,
      );
    }
  }
}
