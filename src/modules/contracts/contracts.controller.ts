...
export class ContractsController {
  ...
  @ApiResponse({
    ...
    description: 'Only clients can create contracts',
  })
  ...
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Invalid update data or contract not in draft',
  })
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Only clients can update contracts',
  })
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Only clients can activate contracts',
  })
  ...
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Invalid milestone or contract status',
  })
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Only assigned freelancer can submit milestones',
  })
  ...
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Milestone not submitted for review',
  })
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Only clients can review milestones',
  })
  async reviewMilestone(
    ...
    return this.contractsService.reviewMilestone(
      contractId,
      milestoneIndex,
      reviewDto,
      req.user.id,
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Not part of this contract',
  })
  async requestModification(
    ...
    return this.contractsService.requestModification(
      contractId,
      modificationDto,
      req.user.id,
    );
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Reason for rejection if approve=false',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
    description: 'Invalid modification or already processed',
  })
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Cannot approve own modification request',
  })
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'No permission to update contract status',
  })
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'Only clients can delete contracts',
  })
