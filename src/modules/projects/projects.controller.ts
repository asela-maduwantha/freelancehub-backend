...
export class ProjectsController {
  ...
  @Get('public')
  @ApiOperation({
    summary: 'Browse projects publicly (no authentication required)',
  })
  ...
  @ApiResponse({
    ...
    description: 'Project is not accepting proposals',
  })
  async submitProposal(
    ...
    return this.projectsService.submitProposal(
      projectId,
      proposalDto,
      req.user.id,
    );
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'You can only accept proposals for your own projects',
  })
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'You can only reject proposals for your own projects',
  })
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'You can only complete your own projects',
  })
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'You can only view analytics for your own projects',
  })
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Freelancer invited successfully',
  })
