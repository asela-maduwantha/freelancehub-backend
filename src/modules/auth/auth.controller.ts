...
export class AuthController {
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Send OTP to email for verification or password reset',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad request - email not found or rate limited',
  })
  ...
  async verifyAuthentication(
    @Body() authDto: VerifyAuthenticationDto,
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Get WebAuthn registration challenge for authenticated user',
  })
  @ApiResponse({
    status: 200,
  ...
  async registerPasskey(
    @Body() passkeyDto: RegisterPasskeyDto,
    @Request() req,
  ) {
    return this.authService.registerPasskey(
