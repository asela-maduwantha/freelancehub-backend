...
export class ClientController {
  ...
  async getClientProjects(
    ...
    return this.clientService.getClientProjects(req.user.id, {
      status,
      page,
      limit,
    });
  ...
  async getPayments(
    ...
    return this.clientService.getPaymentHistory(req.user.id, {
      page,
      limit,
      status,
    });
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Freelancer added to favorites successfully',
  })
  async addFreelancerToFavorites(
    @Request() req: any,
    @Body() favoriteDto: { freelancerId: string },
  ) {
    return this.clientService.addFreelancerToFavorites(
      req.user.id,
      favoriteDto.freelancerId,
    );
  }
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Favorite freelancers retrieved successfully',
  })
  async getFavoriteFreelancers(
    ...
    return this.clientService.getFavoriteFreelancers(req.user.id, {
      page,
      limit,
    });
  }
  ...
  async getSpendingAnalytics(
    ...
    return this.clientService.getSpendingAnalytics(req.user.id, {
      period,
      year,
    });
  }
